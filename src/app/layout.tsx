        ...
        <ThemeProvider defaultTheme="light">
          <SessionProvider>
            <QueryProvider>
              {children}
              <a
                href="https://wa.me/9779767357887"
                target="_blank"
                rel="noopener noreferrer"
                className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 hover:shadow-xl dark:bg-[#128C7E]"
